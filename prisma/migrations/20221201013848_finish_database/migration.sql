...
-- AddForeignKey
ALTER TABLE "UsersList" ADD CONSTRAINT "UsersList_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UsersListToUser" ADD CONSTRAINT "_UsersListToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "UsersList"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UsersListToUser" ADD CONSTRAINT "_UsersListToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
